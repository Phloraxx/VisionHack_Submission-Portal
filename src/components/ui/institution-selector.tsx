...
export function InstitutionSelector({
  ...
  return (
    <div className="space-y-2" ref={containerRef}>
      ...
      <div className="relative" role="combobox" aria-expanded={isOpen} aria-controls="institution-listbox" aria-haspopup="listbox">
          ...
          >
            {institutionsByDistrict.length > 0 ? (
              institutionsByDistrict.map(([district, insts]) => (
                <div key={district} role="group" aria-label={`District: ${district}`}>
                  ...
                  {insts.map((inst) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 hover:bg-gray-100 focus-visible:bg-blue-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 flex items-center justify-between transition-colors ${
