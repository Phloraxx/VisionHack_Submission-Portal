                ...
                <div key={district} role="group" aria-label={district}>
                  ...
                  {insts.map((inst) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 hover:bg-gray-100 flex items-center justify-between transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-ring focus-visible:ring-offset-2 ${
