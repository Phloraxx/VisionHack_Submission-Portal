        ...
        {isOpen && !disabled && (
          ...
          >
            {institutionsByDistrict.length > 0 ? (
                ...
                <div key={district} role="group" aria-label={district}>
                  ...
                  {insts.map((inst) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 hover:bg-gray-100 focus-visible:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset flex items-center justify-between transition-colors ${
              ...
              <div role="status" aria-live="polite" className="px-3 py-8 text-sm text-center text-gray-500">
