...
export function InstitutionSelector({
  ...
  return (
    <div className="space-y-2" ref={containerRef}>
      ...
      <div className="relative" role="combobox" aria-expanded={isOpen} aria-haspopup="listbox" aria-controls="institution-listbox">
        ...
        {/* Dropdown */}
        {isOpen && !disabled && (
          <div id="institution-listbox" role="listbox" className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-md shadow-lg max-h-[300px] overflow-y-auto">
                ...
                <div key={district} role="group" aria-label={district}>
                  ...
                  {insts.map((inst) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 hover:bg-gray-100 flex items-center justify-between transition-colors focus-visible:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset ${
