...
export function getLeadSteps(
  ...
  const steps: Step[] = [
    ...
    { id: "questionnaire", label: "Questionnaire", completed: false, active: false, href: "/lead/questionnaire" },
    { id: "submit-idea", label: "Submit Idea", completed: false, active: false, href: "/lead/submit-idea" },
  ];
