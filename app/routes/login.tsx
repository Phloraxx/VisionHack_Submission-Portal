  ...
  return (
    <div className="vh-min-h-screen-dynamic bg-sidebar md:grid md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
      ...
      {/* ----------------------------------------------------------------
          ...
          ---------------------------------------------------------------- */}
      <aside data-theme="light" className="relative hidden md:flex flex-col overflow-hidden bg-background p-10 text-foreground border-r border-black/10 lg:p-12 xl:p-16">
        ...
        <div className="relative z-10 mt-12 space-y-6 lg:mt-16 lg:space-y-8">
          <div className="space-y-3">
            <h1 className="text-3xl font-semibold tracking-tight leading-[1.1] text-foreground md:text-4xl lg:text-4xl xl:text-5xl" style={{textWrap: "balance"}}>
              Build something real.
              <br />
              <span className="text-primary">Show it here.</span>
            </h1>
            <p className="max-w-md text-sm text-foreground/60 leading-relaxed">
              The submission portal for teams, campus leads, and reviewers
              running VisionHack 2026. Register your team, submit your idea,
              track your progress across the event.
            </p>
          </div>
      ...
      {/* ----------------------------------------------------------------
          ...
          ---------------------------------------------------------------- */}
      <main data-theme="dark" className="flex vh-min-h-screen-dynamic flex-col md:min-h-0" style={{backgroundColor: "#2e2a25"}}>
